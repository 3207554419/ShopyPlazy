...
<body class="recuperar_contraseña" >
        ...
        <div class="login-form">
          ...
          <form class="text-left clearfix">
            ...
            <div class="text-center">
              <button type="submit" class="btn btn-main text-center">Solicitar contraseña</button>
            </div>
          </form>
          <p class="mt-20"><a href="../view/iniciar_sesion.php">Volver inicio sesión</a></p>
        </div>
      </div>
    </div>
  </div>
